...
<section id="container" class="qna-write">
    ...
    <article id="contents" class="">
        ...
        <div class="contents-body m-top-20">
            <form action="{{ isset($edit) ? route("support.qna.update", [ "id" => $id->id ]) : route("support.qna.store") }}" method="post" enctype="multipart/form-data">
                @csrf
                @if (isset($edit))
                    @method("put")
                @endif
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="file-wrap">
                            <input type="text" name="upload_file_1_name" id="upload_file_1_name"  placeholder="선택된 파일 없음" class="input-large upload_text" readonly value="{{ $id->file1name ?? "" }}">
                    ...
                    <tr>
                        ...
                        <td class="file-wrap" colspan="3">
                            <input type="text" name="upload_file_2_name" id="upload_file_2_name" placeholder="선택된 파일 없음" class="input-large upload_text" readonly value="{{ $id->file2name ?? "" }}">
...
<script>
    ...
    $("input[type='file']").on("change", function (e) {
        ...
        var prt = $(this).parents("td");
        var $text = $("input[type='text']", prt);
