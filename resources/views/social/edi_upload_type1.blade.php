<div class="contents-box">
    ...
    <div class="box-top">
        ...
        <div class="m-top-10">
            ...
            <p class="m-clear">
                2. 작성 완료된 파일을 아래 파일 업로드 영역에 업로드하세요.
                <br>
            </p>
            <p class="acc-orange m-clear">* {{$title}} EDI 파일을 업로드하실 때 파일 형식을 csv형식이 아닌 엑셀 통합문서 형식으로 변경한 후 업로드하시기 바랍니다.</p>
            <p class="acc-orange m-clear">* 순번 짤림 유무에 상관없이 다운로드 받은 내용 그대로 업로드하시기 바랍니다.</p>
        </div>
