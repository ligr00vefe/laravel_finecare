...
<section id="member_wrap" class="etc-transportation-wrap list_wrapper">
    ...
    <article id="contents">
        ...
        <div class="contents-box">
            ...
            <div class="box-top">
                <h3>
                    <img src="{{__IMG__}}/icon_doc_small.png" alt="문서아이콘">중증가산수당 등록
                </h3>

                <div class="m-top-20">
                    <p>
                        1. 차세대 전자바우처 사이트(<b class="fc-sky">http://nevs.socialservice.or.kr</b>) 에서 매출 및 정산 > 기타 수당 등 지급조회 > 교통지원금지급내역조회 > 검색버튼을 클릭하여  엑셀파일을 내려받기 하세요.
                    </p>
                    <p>
            ...
            <div class="box-bottom">
                ...
                <form action="/etcIncome/severe/register" method="post" enctype="multipart/form-data">
                    @csrf
