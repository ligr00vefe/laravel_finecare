...
class CreateRecalculateConditionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('recalculate_conditions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('recalculate_conditions');
    }
}
